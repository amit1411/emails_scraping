...
class Oddsportal_Basketball_Ah(op_base.OpBase, mixins.basketball_mixin.BasketballMixin):
	...
	search_from_date = datetime(2019, 12, 8)
	search_to_date = datetime(2019, 11, 10)
